  ...
  for (const uint32_t& title_id : title_ids) {
    ...
    for (const auto& file_info : file_infos) {
      ...
      if (XSUCCEEDED(ReadContentHeaderFile(xe::path_to_utf8(file_info.name),
        ...
        //533007D0 - Caladrius
        if (file_info.name.filename() == "AB1011E523299E273906A2B7B2F7BF36919D1692")
          content_data.set_display_name(u"Additional Character: Nightmare Of The Lilith");
        if (file_info.name.filename() == "C18B9755C5BBBA284F019539EA5E00979E8503A1")
          content_data.set_display_name(u"Additional Character: Sophia Fulcanelli");
